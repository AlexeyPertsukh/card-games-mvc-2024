...
public abstract class AbstractViewFactory implements ViewFactory {
    ...
    protected String[] textHelp(Rules rules, PointCounter counter) {
        ...
        strings.add("If a joker appears and no bet is placed on it, all the player’s points are burned.");
        strings.add("---------");
    ...
    protected static final String RESULT_POINT_BURN_TEMPLATE = "all points burned out, add point: %d%n";
