...
public class Large17x11PicCardMapper extends CombainPicCardMapper {
    ...
    private static Large17x11PicCardMapper factory;

    public static Large17x11PicCardMapper getInstance() {
        if(factory == null) {
            factory = new Large17x11PicCardMapper();
        }
        return factory;
    }
