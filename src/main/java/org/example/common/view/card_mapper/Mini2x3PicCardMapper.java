...
public class Mini2x3PicCardMapper extends CombainPicCardMapper {
...
//    private final static SuitSymbolFactory symbolFactory = new OriginalSuitSymbolFactory();
    ...
    private static Mini2x3PicCardMapper factory;

    public static Mini2x3PicCardMapper getInstance() {
        if(factory == null) {
            factory = new Mini2x3PicCardMapper();
        }
        return factory;
    }
