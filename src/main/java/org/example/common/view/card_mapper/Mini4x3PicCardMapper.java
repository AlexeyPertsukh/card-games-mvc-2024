...
public class Mini4x3PicCardMapper extends CombainPicCardMapper {
...
//    private final static SuitSymbolFactory symbolFactory = new OriginalSuitSymbolFactory();
    ...
    private static Mini4x3PicCardMapper factory;

    public static Mini4x3PicCardMapper getInstance() {
        if(factory == null) {
            factory = new Mini4x3PicCardMapper();
        }
        return factory;
    }
