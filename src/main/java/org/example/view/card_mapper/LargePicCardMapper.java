...
public class LargePicCardMapper extends CombainPicCardMapper {
    ...
    private static LargePicCardMapper factory;

    public static LargePicCardMapper getInstance() {
        if(factory == null) {
            factory = new LargePicCardMapper();
        }
        return factory;
    }
