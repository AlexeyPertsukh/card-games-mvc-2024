...
import org.example.view.card_mapper.suit_symbol_factory.OriginalSuitSymbolFactory;
...
public class MiniPicCardMapper extends CombainPicCardMapper {
...
//    private final static SuitSymbolFactory symbolFactory = new OriginalSuitSymbolFactory();
    ...
    private static MiniPicCardMapper factory;

    public static MiniPicCardMapper getInstance() {
        if(factory == null) {
            factory = new MiniPicCardMapper();
        }
        return factory;
    }
